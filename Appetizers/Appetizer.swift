...
struct MockData {
    static let sampleAppetizer1 = Appetizer(id: 001, name: "Mock Appetizer1", description: "Yummie burnt bannana", price: 6.51, imageURL: "", calories: 10, protein: 20, carbs: 30)
